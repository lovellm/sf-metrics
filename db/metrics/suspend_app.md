...
```sql
CREATE OR REPLACE TASK SF_METRICS.T_STOP_APP_WEEKEND
...
ALTER TASK SF_METRICS.T_STOP_APP_WEEKEND RESUME;
```
...
```sql
CREATE OR REPLACE TASK SF_METRICS.T_STOP_APP_WEEK
  WAREHOUSE = SOME_XSMALL_WAREHOUSE
...
ALTER TASK SF_METRICS.T_STOP_APP_WEEK RESUME;
```
