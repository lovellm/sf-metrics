import { getApiBase } from "./apiConstants";
...
/** Used to issue a request via axios library to a remote endpoint. Assumes the payload and result will always be JSON data. */
export default class HttpRequest {
  ...
  urlFromEndpoint(endpoint: string) {
    return urlFromEndpoint(endpoint);
  }
}
 ...
 */
export const urlFromEndpoint = (endpoint: string) => {
